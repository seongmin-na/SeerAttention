...
from .configuration_qwen3_tidal import TidalQwen3Config
import math
...
class Qwen3Attention(nn.Module):
    ...
    def __init__(self, config: TidalQwen3Config, layer_idx: int):
        super().__init__()
        self.config = config
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        """
        TidalDecode forward pass for Qwen3Attention
        ...
        if self.layer_idx < sparse_layer_start or q_len == kv_seq_len:
            ...
            if self.layer_idx == sparse_layer_start or self.layer_idx == correction_layer:
                # Extract top_k mask at selection layers
...
class Qwen3RotaryEmbedding(nn.Module):
    def __init__(self, config: TidalQwen3Config, device=None):
        super().__init__()
...
class Qwen3Model(Qwen3PreTrainedModel):
    def __init__(self, config: TidalQwen3Config):
